...
def list_accounts():
    """
    Lists accounts in the system
    """
    app.logger.info("Request to list all accounts in the system")
...
def read_account(id):
    """
    Reads an Account
    This endpoint will read an Account based on the id provided in the body
    """
